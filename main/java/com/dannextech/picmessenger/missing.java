 ...
 */
public class missing extends Activity implements View.OnClickListener {
    ImageView image;
    LinearLayout liner;
    Button bt;
    int tophone;
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.imageView14:
                image.setImageResource(R.drawable.thriller);
                break;
            case R.id.imageView13:
                image.setImageResource(R.drawable.thriller1);
                //tophone = R.drawable.images2;
                break;
            case R.id.imageView3:
                image.setImageResource(R.drawable.thriller2);
                //tophone = R.drawable.images4;
                break;
            case R.id.imageView4:
                image.setImageResource(R.drawable.thriller3);
                //tophone = R.drawable.images10;
                break;
            case R.id.imageView5:
                image.setImageResource(R.drawable.thriller4);
                //tophone = R.drawable.images11;
                break;
            case R.id.imageView6:
                image.setImageResource(R.drawable.thriller5);
                break;
            case R.id.imageView7:
                image.setImageResource(R.drawable.thriller6);
                break;
            case R.id.imageView9:
                image.setImageResource(R.drawable.thriller7);
                break;
            case R.id.imageView10:
                image.setImageResource(R.drawable.thriller8);
                break;
            case R.id.imageView11:
                image.setImageResource(R.drawable.thriller9);
                break;
            case R.id.imageView12:
                image.setImageResource(R.drawable.thriller10);
                break;
            case R.id.imageView15:
                image.setImageResource(R.drawable.thriller11);
                break;
            case R.id.imageView2:
                image.setImageResource(R.drawable.thriller12);
                break;
            case R.id.imageView16:
                image.setImageResource(R.drawable.thriller13);
                break;
            case R.id.imageView17:
                image.setImageResource(R.drawable.thriller14);
                break;
            case R.id.button:
